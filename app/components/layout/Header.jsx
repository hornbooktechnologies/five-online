        ...
        <ul className="m-0 p-0 list-none text-black">
          {menu.items.map((item, idx) => (
            <li key={idx} className="border-b border-[#eee]">
              {item.items ? (
                <button
                  className="w-full flex justify-between items-center px-[15px] py-[20px] text-left text-base text-[16px] hover:text-[#6ABD45] transition-colors"
                ...
                <Link href={item.href || '#'} className="block px-[15px] py-[20px] text-base text-[16px] hover:text-[#6ABD45] transition-colors" onClick={closeMobileMenu}>
                  {item.label}
                </Link>
              )}
            </li>
          ...
          {menuId === 'main' && (
            <>
              <li className="border-b border-black/10"><Link href="/contact" className="block p-4 text-base hover:text-[#6ABD45] transition-colors" onClick={closeMobileMenu}>Contact Us</Link></li>
              <li className="border-b border-black/10"><Link href="#" className="block p-4 text-base hover:text-[#6ABD45] transition-colors" onClick={closeMobileMenu}>Terms & Conditions</Link></li>
            </>
          )}
        </ul>
      </div>
                ...
                <div className="flex-grow flex items-center justify-end">
                  <ul className="flex flex-row items-center ms-auto my-0 space-x-1 lg:space-x-2 xl:space-x-4 px-2 py-0.5">
                    ...
                    <li className="relative py-3 lg:py-[30px] px-2 group cursor-pointer">
                      <a className={`flex items-center gap-2 text-[17px] capitalize transition-colors whitespace-nowrap group-hover:text-[#6ABD45] ${pathname.startsWith('/capabilities') ? 'text-[#6ABD45]' : 'text-black'}`} role="button">
                    ...
                    <li className="relative py-3 lg:py-[30px] px-2 group cursor-pointer static">
                      <a className={`flex items-center gap-2 text-[17px] capitalize transition-colors whitespace-nowrap group-hover:text-[#6ABD45] ${pathname.startsWith('/industrie') ? 'text-[#6ABD45]' : 'text-black'}`} role="button">
                        ...
                        <div className="container mx-auto px-4 xl:px-[90px]">
                          <div className="flex flex-wrap -mx-3">
                            <div className="w-1/4 px-4 border-r border-gray-100">
                              <h6 className="text-xl font-bold mb-4 text-black">B2B</h6>
                              <Link href="#" className="block py-2 text-black text-base hover:bg-[#f5f5f5] hover:text-[#6ABD45] transition-colors">Corporate</Link>
                              <Link href="#" className="block py-2 text-black text-base hover:bg-[#f5f5f5] hover:text-[#6ABD45] transition-colors">Real Estate</Link>
                            </div>
                            <div className="w-1/4 px-8">
                              <h6 className="text-xl font-bold mb-4 text-black">eCommerce</h6>
                              <Link href="#" className="block py-2 text-black text-base hover:bg-[#f5f5f5] hover:text-[#6ABD45] transition-colors">Fashion</Link>
                            </div>
                    ...
                    {/* Impact */}
                    <li className="relative py-3 lg:py-[30px] px-2 group cursor-pointer">
                      <a className={`flex items-center gap-2 text-[17px] capitalize transition-colors whitespace-nowrap group-hover:text-[#6ABD45] ${pathname.startsWith('/case-studies') || pathname.startsWith('/portfolio') ? 'text-[#6ABD45]' : 'text-black'}`} role="button">
                      ...
                      <ul className="absolute hidden group-hover:block bg-white top-[95%] -left-4 min-w-[200px] rounded-lg py-2 shadow-[0_10px_30px_rgba(0,0,0,0.1)] border border-[#0000002d] z-50">
                        <li><Link href="/case-studies" className="block px-6 py-2.5 text-[15px] text-black hover:bg-[#f5f5f5] hover:text-[#6ABD45] transition-colors">Case Study</Link></li>
                        <li><Link href="/portfolio" className="block px-6 py-2.5 text-[15px] text-black hover:bg-[#f5f5f5] hover:text-[#6ABD45] transition-colors">Portfolio</Link></li>
                      </ul>
                    </li>

                    {/* Insights */}
                    <li className="relative py-3 lg:py-[30px] px-2 group cursor-pointer">
                      <a className={`flex items-center gap-2 text-[17px] capitalize transition-colors whitespace-nowrap group-hover:text-[#6ABD45] ${pathname.startsWith('/blog') || pathname.startsWith('/insight') ? 'text-[#6ABD45]' : 'text-black'}`} role="button">
                        Insights <ChevronDownIcon />
                      </a>
                      <ul className="absolute hidden group-hover:block bg-white top-[95%] -left-4 min-w-[200px] rounded-lg py-2 shadow-[0_10px_30px_rgba(0,0,0,0.1)] border border-[#0000002d] z-50">
                        <li><Link href="#" className="block px-6 py-2.5 text-[15px] text-black hover:bg-[#f5f5f5] hover:text-[#6ABD45] transition-colors">Blog</Link></li>
                      </ul>
                    </li>

                    {/* About */}
                    <li className="relative py-3 lg:py-[30px] px-2 group cursor-pointer">
                      <a className={`flex items-center gap-2 text-[17px] capitalize transition-colors whitespace-nowrap group-hover:text-[#6ABD45] ${pathname.startsWith('/about') || pathname.startsWith('/career') ? 'text-[#6ABD45]' : 'text-black'}`} role="button">
                        About <ChevronDownIcon />
                      </a>
                      <ul className="absolute hidden group-hover:block bg-white top-[95%] -left-4 min-w-[200px] rounded-lg py-2 shadow-[0_10px_30px_rgba(0,0,0,0.1)] border border-[#0000002d] z-50">
                        <li><Link href="/about" className="block px-6 py-2.5 text-[15px] text-black hover:bg-[#f5f5f5] hover:text-[#6ABD45] transition-colors">About Us</Link></li>
                        <li><Link href="#" className="block px-6 py-2.5 text-[15px] text-black hover:bg-[#f5f5f5] hover:text-[#6ABD45] transition-colors">Career</Link></li>
                      </ul>
                    </li>
                  </ul>
                </div>
