        ...
        <div className="flex flex-wrap">
          <div className="w-full lg:w-3/4">
            <div className="text-left">
              <h2 className="text-[4rem] md:text-[10rem] lg:text-[12rem] leading-none mb-8 text-black">Namaste.</h2>
              <h3 className="mb-4 text-2xl md:text-4xl lg:text-[40px] font-normal leading-[1.35] text-black">We Are India&apos;s Revenue-First <br />Web Design Company.</h3>
